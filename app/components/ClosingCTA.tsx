...
export default function ClosingCTA() {
  return (
    <section
      id="close"
      className="bg-charcoal pt-[120px] max-[700px]:pt-20 pb-[120px] max-[700px]:pb-20 px-[clamp(24px,5vw,80px)] border-t border-cream/[0.08]"
    >
      <div className="max-w-[1000px] mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-[19px] leading-[1.6] text-cream/65 max-w-[500px] mx-auto">
        ...
        <div className="grid gap-px bg-cream/[0.12] [grid-template-columns:repeat(auto-fit,minmax(220px,1fr))] max-[700px]:!grid-cols-2">
