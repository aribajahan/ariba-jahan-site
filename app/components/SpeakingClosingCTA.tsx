...
export default function SpeakingClosingCTA() {
  return (
    <section
      id="close"
      className="bg-cherish pt-[120px] max-[700px]:pt-20 max-[1024px]:pt-24 pb-[120px] max-[700px]:pb-20 max-[1024px]:pb-24 px-[clamp(24px,5vw,80px)]"
    >
      <div className="max-w-[1000px] mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-[19px] leading-[1.6] text-cream/85 max-w-[520px] mx-auto">
            If you&rsquo;re planning an event and think this would resonate with your audience,
            let&rsquo;s talk.
          </p>
        </div>

        <div className="grid gap-px bg-cream/20 [grid-template-columns:repeat(auto-fit,minmax(220px,1fr))] max-[700px]:!grid-cols-2">
