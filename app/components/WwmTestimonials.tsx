...
export default function WwmTestimonials() {
  ...
  return (
    <section className="bg-cream pt-[120px] max-[700px]:pt-[70px] max-[1024px]:pt-24 pb-[120px] max-[700px]:pb-20 max-[1024px]:pb-24 border-t border-charcoal/[0.08] overflow-hidden">
