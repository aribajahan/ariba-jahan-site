...
function PhotoPair({
  ...
  return (
    ...
    >
      ...
      <span
        className="mark-tape absolute left-1/2 inline-block px-[18px] py-[3px] text-[13px] font-extrabold tracking-[0.04em] uppercase text-charcoal whitespace-nowrap z-[3]"
        style={{
          top: chapter.tapeTop,
