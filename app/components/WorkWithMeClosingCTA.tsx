    ...
    >
      <div className="max-w-[1000px] mx-auto">
        <div className="text-center mb-14">
          ...
          <p className="text-[19px] leading-[1.6] text-cream/[0.68] max-w-[480px] mx-auto">
            If you&rsquo;re thinking through a product, CX, AI, or growth question, let&rsquo;s
            chat
          </p>
        </div>

        <div className="grid gap-px bg-cream/[0.15] [grid-template-columns:repeat(auto-fit,minmax(200px,1fr))] max-[700px]:!grid-cols-2">
