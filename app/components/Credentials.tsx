...
export default function Credentials() {
  ...
  return (
    <section className="bg-cherish py-14 max-[700px]:py-10 px-[clamp(24px,5vw,80px)]">
      <div className="reveal no-scrollbar max-w-[1400px] mx-auto flex justify-between gap-7 max-[1024px]:flex-nowrap max-[1024px]:overflow-x-auto max-[1024px]:[scroll-snap-type:x_mandatory] max-[1024px]:gap-5 max-[1024px]:text-center max-[1024px]:-mx-6 max-[1024px]:px-6 max-[1024px]:pb-1">
        {stats.map((s, i) => (
          <div
            key={i}
