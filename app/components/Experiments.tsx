...
export default function Experiments() {
  ...
  return (
    <section id="experiments" className="bg-cream border-t border-charcoal/[0.08]">
      <div className="reveal max-w-[1400px] mx-auto pt-[120px] max-[1024px]:pt-24 max-[700px]:pt-[70px] px-[clamp(24px,5vw,80px)] pb-20 max-[1024px]:pb-16 max-[700px]:pb-14">
        ...
        >
          {experiments.map((entry, i) => {
            ...
            return (
              <div
                key={entry.headline}
                className="relative flex-[0_0_391px] max-[700px]:flex-[0_0_82vw] [transform:rotate(var(--rot))] hover:[transform:rotate(0deg)] transition-transform duration-[380ms] ease-[cubic-bezier(0.23,1,0.32,1)] motion-reduce:transition-none motion-reduce:hover:[transform:rotate(var(--rot))]"
                style={{
