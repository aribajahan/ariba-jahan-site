            ...
            {caseStudies.map((c, i) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* FRONT */}
                    <div className="absolute inset-0 [backface-visibility:hidden] bg-cream border border-charcoal/[0.11] shadow-[0_14px_28px_-12px_rgba(0,0,0,0.15)] p-[30px_30px_34px] max-[700px]:p-5">
                      <span
                    ...
                    {/* BACK */}
                    <div
                      className="absolute inset-0 [backface-visibility:hidden] bg-cream border border-charcoal/[0.11] shadow-[0_14px_28px_-12px_rgba(0,0,0,0.15)] flex flex-col justify-center gap-[18px] max-[700px]:gap-[10px] p-10 max-[700px]:p-5"
